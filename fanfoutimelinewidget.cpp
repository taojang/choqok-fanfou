...
FanfouTimelineWidget::FanfouTimelineWidget( Choqok::Account* account, const QString& timelineName, QWidget* parent )
...
FanfouTimelineWidget::~FanfouTimelineWidget()
{
}

void FanfouTimelineWidget::slotFavoriteCreated( Choqok::Account* account, Choqok::Post* post )
{
...
void FanfouTimelineWidget::slotFavoriteRemoved( Choqok::Account* account, Choqok::Post* post )
{
    if ( account == currentAccount() ) {
        if ( posts().contains( post->postId ) )
