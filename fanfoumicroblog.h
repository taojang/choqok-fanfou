...
#ifndef FANFOUMICROBLOG_H
#define FANFOUMICROBLOG_H
...
class FanfouMicroBlog : public Choqok::MicroBlog
{
    Q_OBJECT
    public:
        explicit FanfouMicroBlog( QObject* parent, const QVariantList& args );
        virtual ~FanfouMicroBlog();
    ...
    private:
        ...
        QHash<KJob*, FanfouAccount*> m_jobAccount;
        QJson::Parser parser;
