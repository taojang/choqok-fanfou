...
#ifndef FANFOUPOSTWIDGET_H
#define FANFOUPOSTWIDGET_H

#include <choqok/postwidget.h>

class FanfouAccount;
class FanfouPostWidget : public Choqok::UI::PostWidget
{
    Q_OBJECT
    public:
        explicit FanfouPostWidget( FanfouAccount *account, const Choqok::Post &post, QWidget *parent = 0 );
        virtual ~FanfouPostWidget();
        virtual void initUi();
    protected Q_SLOTS:
