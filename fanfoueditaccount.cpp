...
FanfouEditAccountWidget::FanfouEditAccountWidget( FanfouMicroBlog* microblog, FanfouAccount* account, QWidget* parent )
: ChoqokEditAccountWidget(account,parent)
{
    ...
    if ( account ) {
        ...
        setAccount( new FanfouAccount( microblog, newAccountAlias ) );
...
FanfouEditAccountWidget::~FanfouEditAccountWidget()
{
}

bool FanfouEditAccountWidget::validateData()
{
    return ( !kcfg_alias->text().isEmpty() && isAuthenticated );
}

Choqok::Account *FanfouEditAccountWidget::apply()
{
    FanfouAccount *acc = static_cast<FanfouAccount*>(account());
...
void FanfouEditAccountWidget::authorizeUser()
{
    FanfouAccount* acc = static_cast<FanfouAccount*>(account());
    QOAuth::Interface* qoauth = acc->qoauthInterface();
    QOAuth::ParamMap reply = qoauth->requestToken( "http://fanfou.com/oauth/request_token",
    ...
    if ( qoauth->error() == QOAuth::NoError ) {
        ...
        QUrl url( "http://fanfou.com/oauth/authorize" );
...
void FanfouEditAccountWidget::getPinCode()
{
    FanfouAccount* acc = static_cast<FanfouAccount*>(account());
    QOAuth::Interface* qoauth = acc->qoauthInterface();
    ...
    while ( !isAuthenticated ) {
        ...
        QOAuth::ParamMap reply = qoauth->accessToken( "http://fanfou.com/oauth/access_token",
...
void FanfouEditAccountWidget::setAuthenticated( bool authenticated )
{
...
void FanfouEditAccountWidget::loadTimelinesTableState()
{
    FanfouAccount* acc = static_cast<FanfouAccount*>(account());
...
void FanfouEditAccountWidget::saveTimelinesTableState()
{
    FanfouAccount* acc = static_cast<FanfouAccount*>(account());
